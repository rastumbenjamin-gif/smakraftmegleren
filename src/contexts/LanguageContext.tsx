...
const translations = {
  en: {
    ...
    "comparison.hydro.details.1.text":
      "You own actual renewable energy infrastructure, not just certificates or promises.",
    "comparison.hydro.details.2.title": "Predictable Returns:",
    "comparison.hydro.details.2.text":
      "Electricity demand is constant, and Norway has a regulated energy market ensuring stable pricing.",
    "comparison.hydro.details.3.title": "Direct Climate Impact:",
    "comparison.hydro.details.3.text":
      "Every kWh produced directly displaces fossil fuel energy and creates measurable CO₂ reduction.",
    ...
    "comparison.carbon.details.2.text":
      "Forests can burn down, projects can fail, but you've already paid for the credits.",
    "comparison.carbon.details.3.title": "No Asset Value:",
    "comparison.carbon.details.3.text":
      "You own nothing tangible - just a digital certificate that can become worthless.",
    ...
    "comparison.esg.details.1.text":
      'Many "ESG" funds still hold fossil fuel companies, weapons manufacturers, and other questionable investments.',
    ...
    "comparison.esg.details.3.text":
      "Your money is spread across hundreds of companies - minimal influence on any single environmental outcome.",
    ...
    "opportunities.buildYear": "Commissioned",
    ...
    "opportunities.offerReceived": "Offer received",

    // Plant specific data
    "opportunities.hindbergelva.advantage1":
      "Winter-peaked output: 44% of annual production comes in Nov–Feb, capturing higher winter prices.",
    "opportunities.hindbergelva.advantage2":
      "Upside potential: Renovated turbine with 10–20% higher yield possibility. Additional 20 kW license application could add ~100 MWh/year.",
    "opportunities.hindbergelva.advantage3":
      "Price leverage: NO03 area expected to rise with new grid connections to southern Norway",
    ...
    "opportunities.sandvik.advantage1":
      "High head (~132 m) with Pelton turbine, efficient energy conversion at low flow rates, giving stable production.",
    "opportunities.sandvik.advantage2":
      "Modern plant (commissioned 2018), low maintenance needs, long technical lifetime, and updated technology.",
    "opportunities.sandvik.advantage3":
      "Solid annual output (~3 GWh) relative to installed capacity (1 MW), ensuring attractive yield in the small hydro segment.",
    "opportunities.vollabekken.advantage1":
      "Stable winter output: Average of 610 MWh produced in Jan–Feb–Dec, supported by natural hydrological buffering.",
    "opportunities.vollabekken.advantage2":
      "Proven operations: Commissioned in 2012, with solid construction and equipment, and no major issues.",
    "opportunities.vollabekken.advantage3": "Attractive economics: Exempt from high-price levy (<1 MW capacity)",
    "opportunities.molnelva.advantage1":
    ...
    "sell.maintenance":
      "Who is responsible for regular maintenance of the power plant, including cleaning, oil changes, etc.? *",
    ...
    "toast.registrationSuccessDesc":
      "Thank you for your interest in {plantName}. We will be in touch soon with more information.",
    ...
    "toast.evaluationSuccessDesc":
      "Thank you for your submission. We'll contact you within 24 hours with a free evaluation of your power plant.",
  ...
  no: {
    ...
    "hero.cta1.line1": "Start å investere i dag",
    "hero.cta1.line2": "Se tilgjengelige kraftverk",
    ...
    "comparison.hydro.details.1.text":
      "Du eier infrastruktur for fornybar energi, ikke bare sertifikater eller løfter.",
    "comparison.hydro.details.2.title": "Forutsigbar Avkastning:",
    "comparison.hydro.details.2.text":
      "Strømetterspørselen er konstant, og Norge har et regulert energimarked som sikrer stabil prising.",
    "comparison.hydro.details.3.title": "Direkte Klimapåvirkning:",
    "comparison.hydro.details.3.text":
      "Hver kWh produsert fortrenger direkte fossil energi og skaper målbar CO₂-reduksjon.",
    ...
    "comparison.carbon.details.1.text":
      'Mange prosjekter ville ha skjedd uansett, noe som gjør "offsettet" meningsløst.',
    "comparison.carbon.details.2.title": "Ingen Permanent Påvirkning:",
    "comparison.carbon.details.2.text":
      "Skoger kan brenne ned, prosjekter kan mislykkes, men du har allerede betalt for kredittene.",
    "comparison.carbon.details.3.title": "Ingen Eiendel-verdi:",
    "comparison.carbon.details.3.text":
      "Du eier ingenting håndgripelig - bare et digitalt sertifikat som kan bli verdiløst.",
    ...
    "comparison.esg.details.1.text":
      'Mange "ESG"-fond holder fortsatt fossil-selskaper, våpenprodusenter og andre tvilsomme investeringer.',
    "comparison.esg.details.2.title": "Gebyr-erosjon:",
    "comparison.esg.details.2.text":
      "1-2% årlige gebyrer sammensetter seg over tid og reduserer avkastningen betydelig.",
    "comparison.esg.details.3.title": "Utvannet Påvirkning:",
    "comparison.esg.details.3.text":
      "Pengene dine er spredt over hundrevis av selskaper - minimal innflytelse på enkelt miljøutfall.",
    ...
    "opportunities.buildYear": "Idriftsatt",
    ...
    // Plant specific data
    "opportunities.hindbergelva.advantage1":
      "Vintertoppet produksjon: 44 % av årsproduksjonen leveres i nov–feb, og fanger inn høyere vinterpriser.",
    "opportunities.hindbergelva.advantage2":
      "Oppsidepotensial: Renovert turbin kan gi 10–20 % mer produksjon. I tillegg kan en 20 kW konsesjonsutvidelse gi ~100 MWh/år ekstra.",
    ...
    "opportunities.sandvik.advantage1":
      "Høyt fall (~132 m) med Pelton-turbin: effektiv energikonvertering ved lav vannføring, som gir stabil produksjon.",
    "opportunities.sandvik.advantage2":
      "Moderne kraftverk (idrift 2018) med lave vedlikeholdsbehov, lang teknisk levetid og oppdatert teknologi.",
    "opportunities.sandvik.advantage3":
      "Solid årsproduksjon (~3 GWh) i forhold til installert kapasitet (1 MW), som sikrer attraktiv avkastning i småkraftsegmentet.",
    "opportunities.vollabekken.advantage1":
      "Stabil vinterproduksjon: Gj.snitt på 610 MWh i jan–feb–des, støttet av naturlig hydrologisk demping.",
    "opportunities.vollabekken.advantage2":
      "Dokumentert drift: Satt i drift i 2012 med solid bygg og utstyr – ingen større problemer siden oppstart.",
    ...
    "sell.maintenance":
      "Hvem er ansvarlig for regelmessig vedlikehold av kraftverket, inkludert rengjøring, oljeskift osv.? *",
    ...
    "toast.registrationSuccessDesc":
      "Takk for din interesse i {plantName}. Vi vil ta kontakt snart med mer informasjon.",
    ...
    "toast.evaluationSuccessDesc":
      "Takk for din innsendelse. Vi vil kontakte deg innen 24 timer med en gratis evaluering av kraftverket ditt.",
