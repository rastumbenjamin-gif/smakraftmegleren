...
const translations = {
  en: {
    ...
    // Plant specific data
    'opportunities.hindbergelva.advantage1': 'Winter-peaked output: 44% of annual production comes in Nov–Feb, capturing higher winter prices.',
    'opportunities.hindbergelva.advantage2': 'Upside potential: Renovated turbine with 10–20% higher yield possibility. Additional 20 kW license application could add ~100 MWh/year.',
    ...
    'opportunities.sandvik.advantage1': 'High head (~132 m) with Pelton turbine, efficient energy conversion at low flow rates, giving stable production.',
    'opportunities.sandvik.advantage2': 'Modern plant (commissioned 2018), low maintenance needs, long technical lifetime, and updated technology.',
    'opportunities.sandvik.advantage3': 'Solid annual output (~3 GWh) relative to installed capacity (1 MW), ensuring attractive yield in the small hydro segment.',
    'opportunities.vollabekken.advantage1': 'Stable winter output: Average of 610 MWh produced in Jan–Feb–Dec, supported by natural hydrological buffering.',
    'opportunities.vollabekken.advantage2': 'Proven operations: Commissioned in 2012, with solid construction and equipment, and no major issues.',
  ...
  no: {
    ...
    // Plant specific data
    'opportunities.hindbergelva.advantage1': 'Vintertoppet produksjon: 44 % av årsproduksjonen leveres i nov–feb, og fanger inn høyere vinterpriser.',
    'opportunities.hindbergelva.advantage2': 'Oppsidepotensial: Renovert turbin kan gi 10–20 % mer produksjon. I tillegg kan en 20 kW konsesjonsutvidelse gi ~100 MWh/år ekstra.',
    ...
    'opportunities.sandvik.advantage1': 'Høyt fall (~132 m) med Pelton-turbin: effektiv energikonvertering ved lav vannføring, som gir stabil produksjon.',
    'opportunities.sandvik.advantage2': 'Moderne kraftverk (idrift 2018) med lave vedlikeholdsbehov, lang teknisk levetid og oppdatert teknologi.',
    'opportunities.sandvik.advantage3': 'Solid årsproduksjon (~3 GWh) i forhold til installert kapasitet (1 MW), som sikrer attraktiv avkastning i småkraftsegmentet.',
    'opportunities.vollabekken.advantage1': 'Stabil vinterproduksjon: Gj.snitt på 610 MWh i jan–feb–des, støttet av naturlig hydrologisk demping.',
    'opportunities.vollabekken.advantage2': 'Dokumentert drift: Satt i drift i 2012 med solid bygg og utstyr – ingen større problemer siden oppstart.',
